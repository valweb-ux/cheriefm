...
('Про нас', 'about', 'Зміст сторінки про нас', true, (SELECT id FROM languages WHERE code = 'uk' LIMIT 1)),
('Контакти', 'contacts', 'Зміст сторінки контактів', true, (SELECT id FROM languages WHERE code = 'uk' LIMIT 1));
...
INSERT INTO news (title, excerpt, image, category, published, published_at) VALUES 
('Новина 1', 'Короткий опис новини 1', '/placeholder.svg?height=300&width=300', 'Музика', true, NOW()),
('Новина 2', 'Короткий опис новини 2', '/placeholder.svg?height=300&width=300', 'Культура', true, NOW() - INTERVAL '2 days');
